...
<header class="flex justify-between items-center px-6 py-5 backdrop-blur-xl bg-white/5 border-b border-white/10 sticky top-0 z-50">
    ...
    <h1 class="text-lg font-bold bg-gradient-to-r from-pink-400 to-blue-400 bg-clip-text text-transparent">
        LISSE
    </h1>


    <a href="carrinho.php" class="relative text-lg hover:scale-110 transition">
        🛒
...
<div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 gap-6">
...
<div class="bg-[#0b1120]/90 backdrop-blur-2xl rounded-[26px] p-4 flex flex-col h-full">
...
<img src="<?= $img ?>" class="w-full h-32 object-cover group-hover:scale-110 transition duration-500">
<?php endforeach; ?>
</div>

<h3 class="text-sm font-semibold mb-1"><?= $servico['nome']; ?></h3>

<p class="text-gray-400 text-sm"><?= $servico['descricao']; ?></p>

<div class="flex justify-between items-center mt-5">

<span class="text-lg font-bold bg-gradient-to-r from-pink-400 to-blue-400 bg-clip-text text-transparent">
...
<h3 class="text-sm font-semibold"><?= $servico['nome'] ?></h3>
